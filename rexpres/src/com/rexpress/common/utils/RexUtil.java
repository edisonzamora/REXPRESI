...
public class RexUtil {
	...
	public static List<String> idiomasNavegador() {

		String navIdiona = ((HttpServletRequest) fcCuCurrentInstance().getExternalContext().getRequest()).getHeader("Accept-Language");
